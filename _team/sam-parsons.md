...
Sam Parsons is a postdoctoral research associate in the [Oxford Centre for Emotions and Affective Neuroscience](https://www.psy.ox.ac.uk/research/ocean){:target="_blank"} with Professor Elaine Fox.
...
Sam is also on the Experimental Psychology Open Science Committee, and part of the [Steering Committee for a Framework for Open and Reproducible Research Training](https://forrt.netlify.com/){:target="_blank"} (FORRT). One of FORRT’s goals is to curate open teaching materials and their pedagogies to support teachers wishing to incorporate open and reproducible research into their courses, as well as advocating for wide recognition and appreciation of those sharing their teaching materials.
