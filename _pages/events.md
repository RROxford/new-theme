...
For each of our activities, please follow our [Code of Conduct]({{ site.url }}{{ site.baseurl }}/misc/RROxCoC.pdf) which relies on the [UKRN Code of Conduct](https://www.ukrn.org/code-of-conduct/).
